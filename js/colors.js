...
function colorForType(type) {
  if (!type) return COLORS.layer.endpoint;
  ...
  return lookup[normalized] || COLORS.layer[normalized] || COLORS.links.default;
}

export { COLORS, colorForType };
